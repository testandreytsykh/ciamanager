...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <custom>false</custom>
    <layoutAssignments>
        <layout>Accessories_Fieldz__mdt-Threat Tier Mappings Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>MagazineSubscriber__c-MagazineSubscriber Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Magazine__c-Magazine Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>PriceBook__c-Price book Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
